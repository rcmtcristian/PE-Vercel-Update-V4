  ...
  return (
    ...
    >
      ...
      <div className="w-full max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-8 xl:px-12">
        <div className="flex flex-col items-start self-stretch justify-start gap-4 px-2 sm:gap-5 md:gap-6 sm:px-4 md:px-6 lg:px-8 xl:px-12">
          <div className="flex flex-col items-start justify-start w-full gap-4 mx-auto sm:gap-5 md:gap-6 max-w-7xl">
            <div className="w-full text-lg text-left sm:text-xl md:text-2xl lg:text-3xl text-color-palette-primary-black font-subtitle-font-family font-subtitle-font-weight">
            ...
            <div className="w-full text-xl text-left sm:text-2xl md:text-3xl lg:text-4xl text-color-palette-primary-black font-header-font-family font-header-font-weight">
              Our goal: Return 304 Million hectares of land to conservation
              efforts
            </div>
          </div>

          <div className="grid w-full grid-cols-1 gap-4 py-5 mx-auto sm:gap-5 md:gap-6 max-w-7xl sm:grid-cols-2 lg:grid-cols-3 sm:py-6 md:py-7">
            <YellowBorder
          ...
          <div className="w-full text-xl text-center sm:text-2xl md:text-3xl lg:text-4xl text-color-palette-primary-black font-header-font-family font-header-font-weight">
            Our Team
          </div>
          <div className="grid w-full grid-cols-1 gap-4 py-5 mx-auto sm:gap-5 md:gap-6 max-w-7xl sm:grid-cols-2 lg:grid-cols-3 sm:py-6 md:py-7">
            <YellowBorder
              ...
              link="https://www.linkedin.com/in/evelynluu"
              linkIcon="linkedin0.svg"
            />
            <YellowBorder
              header="Glenn Piludu"
            ...
            />
            <YellowBorder
              header="Edie Hreczuch"
              description="Communications Director"
              imageSrc="Edie.webp"
              link="https://www.linkedin.com/in/ednahreczuch/"
              linkIcon="linkedin0.svg"
            />
            <YellowBorder
              header="Alexis Gonzalez"
              description="Mentorship Director"
              imageSrc="Alexis.webp"
              link="https://www.linkedin.com/in/alex-is-gonzalez/"
              linkIcon="linkedin0.svg"
            />
            <YellowBorder
              header="Cristian Richards"
              description="Engineering Manager"
              imageSrc="Cristian.webp"
              link="https://www.linkedin.com/in/cristian-richards/"
              linkIcon="linkedin0.svg"
              textAlign="center"
            />
            {/* <YellowBorder
              ...
              description="The data we facilitate help land trusts make cases for the resources needed to remove invasive species that are drying up creeks and making land arable. By replenishing Indigenous species, we also protect against loss of land through erosion and wild fires."
              imageSrc="Lita.webp"
              link="https://www.pampam.city/p/UkWE9ftI1EbJXZPlNXKC"
              linkIcon="linkedin0.svg"
            /> */}
          </div>
          {/* <SectionHeader />
