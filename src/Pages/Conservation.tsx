    ...
    >
      ...
      <div className="flex flex-col items-start self-stretch justify-start gap-6 px-4 md:px-8 lg:px-16 xl:px-24">
        <div className="flex flex-col items-start justify-start w-full gap-6 mx-auto max-w-7xl">
          ...
          <div className="w-full text-base text-left text-color-palette-primary-black font-body-font-family md:text-lg lg:text-xl font-body-font-weight">
        ...
        <div className="grid w-full grid-cols-1 gap-6 mx-auto max-w-7xl sm:grid-cols-2 lg:grid-cols-3">
          <YellowBorder
