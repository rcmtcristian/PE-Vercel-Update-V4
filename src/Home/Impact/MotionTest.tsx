    ...
    <ReactLenis root>
      <main className="bg-black">
        <div className="wrapper">
          <section className="sticky top-0 grid w-full h-screen text-white bg-slate-950 place-content-center">
        ...
        <section className="w-full text-white bg-slate-950 ">
          <div className="grid grid-cols-12 gap-2">
            ...
            <div className="grid col-span-4 gap-2">
              <figure className="w-full ">
                <img
                  ...
                  alt=""
                  className="object-cover w-full align-bottom transition-all duration-300 rounded-md h-96 "
                />
              </figure>
              <figure className="w-full ">
                <img
            ...
            {/* sticky part */}
            <div className="sticky top-0 grid w-full h-screen col-span-4 grid-rows-3 gap-2">
              <figure className="w-full h-full ">
                <img
                  src="https://images.unsplash.com/photo-1718969604981-de826f44ce15?w=500&auto=format&fit=crop"
                  alt=""
                  className="object-cover w-full h-full align-bottom transition-all duration-300 rounded-md "
                />
              </figure>
              <figure className="w-full h-full ">
                <img
        ...
        <footer className="group bg-slate-950 ">
          ...
          <div className="relative z-10 grid h-40 text-2xl bg-black rounded-tl-full rounded-tr-full place-content-center"></div>
        </footer>
      </main>
    </ReactLenis>
  );
