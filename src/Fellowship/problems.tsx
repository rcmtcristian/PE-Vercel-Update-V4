          ...
          <div className="flex flex-col gap-6">
            ...
            <div>
              ...
              <p className="text-left text-color-palette-primary-black font-body-font-family text-body-font-size font-body-font-weight">
                ...
                ProgramEarth emerged as a response to accelerate carbon capture
                through reforestation. The United Nations highlights that
                restoring and returning 50% of natural areas to conservation is
                one of the most effective ways to reduce our carbon footprint.
                <br />
                <br />
                As children of land stewards, we combine deep earth connections
                with technology. ProgramEarth is a global, interdisciplinary
                initiative with a singular goal: to harness technology,
                Indigenous ecological knowledge, and community-driven action to
                create a comprehensive, executable plan for planetary
                restoration—practical, scalable, and accessible to everyone from
